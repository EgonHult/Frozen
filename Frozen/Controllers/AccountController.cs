...
namespace Frozen.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        public async Task<IActionResult> Update(User user)
        {
            if (ModelState.IsValid)
            {
                ...
                if (canBeRegistered)
                {
                    ...
                    var response = await _clientService.SendRequestToGatewayAsync(ApiLocation.Users.GATEWAY_BASEURL + loggedInUserId, HttpMethod.Put, user);
        ...
        {
            var response = await _clientService.SendRequestToGatewayAsync(ApiLocation.Users.CHECK_EMAIL_AVAILABILITY + updateEmail, HttpMethod.Get);
        ...
        private async Task<User> GetUserAsync()
        {
            ...
            var response = await _clientService.SendRequestToGatewayAsync(ApiLocation.Users.GET_USER + userId, HttpMethod.Get);
